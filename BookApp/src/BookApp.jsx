    ...
    >
      ...
      >
        <input
          ...
          required
          style={{ flex: "1 1 200px", padding: 8, fontSize: 16 }}
        />
        <input
          name="author"
          placeholder="Autor"
          ...
          onChange={handleChange}
          required
          style={{ flex: "1 1 180px", padding: 8, fontSize: 16 }}
        />
        <input
          name="year"
          type="number"
        ...
        <input
          ...
          onChange={handleChange}
          required
          style={{ flex: "1 1 150px", padding: 8, fontSize: 16 }}
        />
        <input
          name="pages"
          type="number"
                ...
                <div style={{ display: "flex", gap: 8 }}>
                  <button
                    ...
                    onClick={async () => {
                      ...
                      // Al enviar el formulario, si hay un id en edición, hacer PUT en vez de POST
